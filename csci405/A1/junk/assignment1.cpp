   ...
   {  // Do some rotation according to start and current rotation vectors
      ...
      {  
		 ...
		 vector3 rotationAxis = vector3::CrossProduct(currRotationVector,strtRotationVector);
                 ...
                 glRotatef(rotationAngle * 2, -rotationAxis.Y(),  -rotationAxis.Y(),-rotationAxis.Z());
...
void renderScene(void)
{
	...
	glPushMatrix();
	{
		...
		//glDrawElements(GL_TRIANGLES, 60, GL_UNSIGNED_BYTE, gsIndices); //using vertex position 
